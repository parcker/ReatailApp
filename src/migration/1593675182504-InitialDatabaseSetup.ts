...
export class InitialDatabaseSetup1593675182504 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "username" character varying NOT NULL, "email" character varying NOT NULL, "emailConfirmed" boolean NOT NULL, "password" character varying NOT NULL, "twoFactorEnable" boolean NOT NULL, "accessFailedCount" integer NOT NULL, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "isDisabled" boolean NOT NULL, "phonenumber" character varying NOT NULL, "businessId" uuid, "businesslocationId" uuid, CONSTRAINT "REL_78725ac7117e7526e028014606" UNIQUE ("businessId"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "sales" ("dateCreated" TIMESTAMP NOT NULL DEFAULT now(), "dateUpdated" TIMESTAMP NOT NULL DEFAULT now(), "isDisabled" boolean NOT NULL, "createdby" character varying NOT NULL, "updatedby" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "customerId" uuid, "businesslocationId" uuid, CONSTRAINT "PK_4f0bc990ae81dba46da680895ea" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "product_configuration" ("dateCreated" TIMESTAMP NOT NULL DEFAULT now(), "dateUpdated" TIMESTAMP NOT NULL DEFAULT now(), "isDisabled" boolean NOT NULL, "createdby" character varying NOT NULL, "updatedby" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "pack" integer NOT NULL, "leadtime" integer NOT NULL, "canexpire" boolean NOT NULL, "canbesold" boolean NOT NULL, "canbepurchased" boolean NOT NULL, "anypromo" boolean NOT NULL, CONSTRAINT "PK_234f05214d60c49e9a673bd7e2f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "stock_transfer" ("dateCreated" TIMESTAMP NOT NULL DEFAULT now(), "dateUpdated" TIMESTAMP NOT NULL DEFAULT now(), "isDisabled" boolean NOT NULL, "createdby" character varying NOT NULL, "updatedby" character varying NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "transfertype" integer NOT NULL, "businesslocationFromId" uuid, "businesslocationToId" uuid, CONSTRAINT "PK_b6165ea3cc5b8062e7eaa1bd44d" PRIMARY KEY ("id"))`);
