...
export class DatabaseInitialization1570480486002 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("CREATE TABLE `business` (`dateCreated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `dateUpdated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `id` varchar(36) NOT NULL, `name` varchar(255) NOT NULL, `address` varchar(255) NOT NULL, `IsActive` tinyint NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `role` (`dateCreated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `dateUpdated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `id` varchar(36) NOT NULL, `name` varchar(255) NOT NULL, `description` varchar(255) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `role_user` (`dateCreated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `dateUpdated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `id` varchar(36) NOT NULL, `userId` varchar(36) NULL, `roleId` varchar(36) NULL, UNIQUE INDEX `REL_2a23ceb75c7511d0523c4aaf49` (`userId`), UNIQUE INDEX `REL_89e55dae19555d0d5fe8602b28` (`roleId`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
